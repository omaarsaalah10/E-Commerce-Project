...
export const emailTemplate =(email)=>{
    const token = jwt.sign({email:email}, "NTIG13Mail")
    return (`
        <!--
...
<table 
class="t20"
 role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
 <tr><td class="t19"
  ...
  href="http://localhost:3000/user/verify/${token}" 
   ...
   Verify my account</a></td></tr></table>
</td></tr></table>
